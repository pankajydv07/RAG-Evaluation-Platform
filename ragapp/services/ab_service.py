...
from ragapp.providers.base import EmbeddingProvider, LLMProvider
from ragapp.providers.factory import get_llm_provider
...
from ragapp.schemas.ab_test import ABTestRequest, ABTestResponse, ModelOutput
...
class ABTestingService:
    ...
    async def run_ab_test(self, req: ABTestRequest) -> ABTestResponse:
        ...
        from ragapp.providers.groq_provider import GroqProvider
        from ragapp.providers.nebius_provider import NebiusLLMProvider
